...
class SignupVC: BaseVC {
    ...
    override func viewDidLoad() {
        ...
        addTapGesture(to: user_nameLbl, selector: #selector(userTapped(_:)))
...
extension SignupVC: FPNTextFieldDelegate {
    ...
    func Signup()
    {
        ...
        dic["restaurant_name"] = resturant_nameTF.text as AnyObject
        dic["username"] = user_nameTF.text as AnyObject
        dic["contact_name"] = nameTF.text as AnyObject
        dic["password"] = passwordTF.text as AnyObject
        dic["contact_email"] = emailTF.text as AnyObject
        dic["contact_phone"] = number as AnyObject
        dic["address"] = addressTF.text as AnyObject
        dic["merchant_type"] = type as AnyObject

        ALF.shared.doPostData(parameters: dic, method: "/api/merchants/profiles", success: { (response) in
